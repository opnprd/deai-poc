var Reporter = (function (exports, Vue, L) {
	...
	*/
	...
	// });
	// export const Esri_WorldStreetMap = L.tileLayer('https://server.arcgisonline.com/ArcGIS/rest/services/World_Street_Map/MapServer/tile/{z}/{y}/{x}', {
	...
	// });
	var Wikimedia = {
	  template: 'https://maps.wikimedia.org/osm-intl/{z}/{x}/{y}{r}.png',
	  options: {
	...
	function initMap() {
	  ...
	  var baseLayer = L.tileLayer(Wikimedia.template, Wikimedia.options);
	  baseLayer.addTo(map);
	  var overlays = {};
